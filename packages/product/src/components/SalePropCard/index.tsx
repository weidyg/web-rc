...
import { Alert, Button, Card, Checkbox, Dropdown, Flex, FormItemProps, Image, Input, Menu, MenuProps, Modal, Radio, Space, Switch, Typography } from 'antd';
...
const SalePropCard = forwardRef<SalePropCardRef, SalePropCardProps>((props: SalePropCardProps, ref: Ref<SalePropCardRef>) => {
