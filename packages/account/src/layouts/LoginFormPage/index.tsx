        ...
        {company && (
          <>
            <div className={classNames(`${prefixCls}-copyright`, hashId)} {...restProps}>
              <span>
                Copyright {!year || year === endYear ? endYear : `${year}-${endYear}`} © {company}
              </span>
              {icp && (
              ...
              {beian && (
                <a target="_blank" href={`//www.beian.gov.cn/portal/registerSystemInfo?recordcode=${beianNo}`}>
      ...
      <div className={classNames(`${prefixCls}`, hashId)}>
        ...
        >
          ...
          <div className={classNames(`${prefixCls}-container`, hashId)}>
            <div className={classNames(`${prefixCls}-ad`, hashId)}></div>
